...
describe Integer do
  ...
  it 'reads thousands' do
    ...
    expect(327689.in_words).to eq('three hundred twenty seven thousand six hundred eighty nine')
  end

  it 'reads millions' do
    expect(10_000_001.in_words).to eq('ten million one')
    expect(12327689.in_words).to eq('twelve million three hundred twenty seven thousand six hundred eighty nine')
  end

  it 'reads billions' do
    expect(1_234_567_890.in_words).to eq(
  ...
  it 'reads trillions' do
    ...
    expect(1_888_259_040_036.in_words).to eq(
      'one trillion eight hundred eighty eight billion two hundred fifty nine million forty ' \
      'thousand thirty six'
    )
  end
end
